...
| ----------------------- | --------- | --------------------------------------------------------------------------------- | -------------------- |
| `onClickBehavior`       | `string` | Whether the user should be redirected to the product page but the product will not be added to cart (`go-to-product-page`) | `add-to-cart`              |
