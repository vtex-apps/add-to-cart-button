...
| `onClickEventPropagation`       | `enum` | Controls how the 'onClick' event triggered upon user clicks is propagated to other elements in the DOM. Possible values are: `disabled` and `enabled`. | `disabled`              |
